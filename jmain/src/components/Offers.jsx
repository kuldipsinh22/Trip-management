                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-3 col-1680-4">
                      <div className="offers_image_container">
                        ...
                        <div
                          className="offers_image_background"
                          style={{ backgroundImage: "url(images/offer_5.jpg)" }}
                        />
                        <div className="offer_name">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-3 col-1680-4">
                      <div className="offers_image_container">
                        ...
                        <div
                          className="offers_image_background"
                          style={{ backgroundImage: "url(images/offer_6.jpg)" }}
                        />
                        <div className="offer_name">
                          <a href="single_listing.html">grand castle</a>
                        </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-3 col-1680-4">
                      <div className="offers_image_container">
                        ...
                        <div
                          className="offers_image_background"
                          style={{ backgroundImage: "url(images/offer_7.jpg)" }}
                        />
                        <div className="offer_name">
                          <a href="single_listing.html">eurostar hotel</a>
                        </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-3 col-1680-4">
                      <div className="offers_image_container">
                        ...
                        <div
                          className="offers_image_background"
                          style={{ backgroundImage: "url(images/offer_8.jpg)" }}
                        />
                        <div className="offer_name">
                          <a href="single_listing.html">grand castle</a>
                        </div>
